...
class Config:
    def __init__(
        ...
        # local folder where the manifest file will be saved/loaded from.
        ...
        # this is where your authentication cookie will be saved/loaded from, use to avoid to request authorization every time you run.
        ...
        # encryption settings
        # decide if we save/load a salted hashed (secure) version of your password on local, otherwise ask for it every use.
        self.encryption_save_salted_password_flag = True
        # where to save/load your salted password hash
        self.encryption_salted_folder_path = config_folder_path
        # where to save/load the app key
        self.app_key_folder_path = module_folder_path
